...
function cpt_careers(){
	...
	if( isset($quantum_options['opt-careers-post-type-slug']) && !empty($quantum_options['opt-careers-post-type-slug']) ) {
		$url_rewrite = $quantum_options['opt-careers-post-type-slug'];
	} 

	register_post_type('post_careers',
		array(
			'labels' => array(
				'name' => esc_attr__( 'Careers', 'quantumtheme' ),
				'singular_name' => esc_attr__( 'Careers', 'quantumtheme' ),
				'add_new' => esc_attr__( 'Add New Career', 'quantumtheme' ),
				'add_new_item' => esc_attr__( 'Add New Career', 'quantumtheme' ),
				'edit' => esc_attr__( 'Edit', 'quantumtheme' ),
				'edit_item' => esc_attr__( 'Edit Career', 'quantumtheme' ),
				'new_item' => esc_attr__( 'New Career', 'quantumtheme' ),
				'view' => esc_attr__( 'View', 'quantumtheme' ),
				'view_item' => esc_attr__( 'View Career', 'quantumtheme' ),
				'search_items' => esc_attr__( 'Search Careers', 'quantumtheme' ),
				'not_found' => esc_attr__( 'No Careers found', 'quantumtheme' ),
				'not_found_in_trash' => esc_attr__( 'No Careers found in Trash', 'quantumtheme' ),
				'parent' => esc_attr__( 'Parent Career', 'quantumtheme' )
			),
			'description' =>  esc_attr__( 'Easily lets you add new careers', 'quantumtheme' ),
			'public' => true,
			'show_ui' => true, 
			'_builtin' => false,
			'map_meta_cap' => true,
