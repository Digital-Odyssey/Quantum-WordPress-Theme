...
class WPBakeryShortCode_pm_ln_recent_properties extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        <?php endwhile; else: ?>
        	...
        	<p><?php esc_html__('No recent properties were found.', 'quantumtheme') ?></p>
...
vc_map( array(
    ...
    "name"      => __("Recent Properties", 'quantumtheme'),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            "type" => "textfield",
            "heading" => __("Number of Properties to display", 'quantumtheme'),
            "param_name" => "num_of_posts",
            "description" => __("Enter a positive integer.", 'quantumtheme')
        ),
