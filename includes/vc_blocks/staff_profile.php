    ...
    protected function content($atts, $content = null) {
        ...
        <div class="pm-staff-profile-container <?php esc_attr_e($class); ?>" data-wow-delay="<?php esc_attr_e($animation_delay); ?>s" data-wow-offset="50" data-wow-duration="1s">
            ...
            <div class="pm-staff-profile-details">
                <a href="<?php echo get_post_permalink($postID); ?>"><p class="pm-staff-profile-name" style="color:<?php esc_attr_e($name_color); ?>;"><?php esc_attr_e($postTitle); ?></p></a>
                <p class="pm-staff-profile-title" style="color:<?php esc_attr_e($title_color); ?>;"><?php esc_attr_e($pm_staff_title_meta); ?></p>
                <p class="pm-staff-profile-bio" style="color:<?php esc_attr_e($text_color); ?>;"><?php esc_attr_e($shortExcerpt); ?> <a href="<?php echo get_post_permalink($postID); ?>">[...]</a></p>
            </div>
        </div>
...
vc_map( array(
    ...
    "name"      => __("Staff Profile", 'quantumtheme'),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            "type" => "textfield",
            "heading" => __("Staff Post ID", 'quantumtheme'),
            "param_name" => "id",
            "description" => __("Enter the ID number of the staff post you wish to display.", 'quantumtheme'),
			"value" => ''
        ),
