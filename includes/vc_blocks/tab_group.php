...
vc_map( array(
    ...
    "params" => array(
       ...
       array(
            ...
            "param_name" => "el_id",
            "description" => __("Assign a unique number value for this Tab Group. If you are creating multiple Tab Groups on a single page please make sure each Tab Group has a unique number assigned to it in order to avoid conflicts between menus.", 'quantumtheme'),
...
vc_map( array(
    "name" => __("Tab Menu Item", 'quantumtheme'),
