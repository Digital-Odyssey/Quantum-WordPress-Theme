...
vc_map( array(
    "name" => __("Slider Carousel", 'quantumtheme'),
    ...
    "params" => array(
       ...
       array(
            "type" => "dropdown",
            "heading" => __("Animation Type", 'quantumtheme'),
            "param_name" => "el_animation",
            "description" => __("Choose between a slide or fade effect.", 'quantumtheme'),
...
vc_map( array(
    ...
    "params" => array(
        ...
        array(
            "type" => "textfield",
            "heading" => __("Alt attribute", 'quantumtheme'),
            "param_name" => "el_title",
            "description" => __("Enter a descriptive alt attribute - this is used for SEO purposes.", 'quantumtheme'),
			"value" => ''
        ),
		...
		array(
            ...
            "param_name" => "el_image",
            "description" => __("Upload an image for your slide.", 'quantumtheme')
        ),
