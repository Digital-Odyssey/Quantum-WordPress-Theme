...
class pulsar_flickr extends WP_Widget {
	function pulsar_flickr() {
		...
		$widget_ops = array('classname' => 'flickr','description' => esc_attr__('Flickr Widget - displays Flickr photos','quantumtheme'));
		parent::__construct('flickr-photo',esc_attr__('[Micro Themes] - Flickr','quantumtheme'),$widget_ops);
	...
	function widget( $args, $instance ) {
		...
		$title = apply_filters( 'widget_title', empty( $instance['title'] ) ? esc_attr__( 'Flickr', 'quantumtheme' ) : $instance['title'], $instance, $this->id_base );
...
function form( $instance ) {
		...
		$defaults = array( 'title' => esc_attr__('Flickr','theme'), 
	...
	<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'flickrID' )); ?>"><?php esc_attr_e('Flickr ID:', 'quantumtheme'); ?> (<a href="http://idgettr.com/"><?php esc_attr_e('idGettr', 'quantumtheme'); ?></a>)</label>
	...
	<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'count' )); ?>"><?php esc_attr_e('Number of Photos:', 'quantumtheme') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'type' ); ?>"><?php esc_attr_e('Type (user or group):', 'quantumtheme') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'display' ); ?>"><?php esc_attr_e('Display (random or latest):', 'quantumtheme') ?></label>
