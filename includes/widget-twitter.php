...
class lateset_tweets extends WP_Widget {
	function lateset_tweets() {
		...
		$widget_ops = array('classname' => 'tweets','description' => esc_attr__('Twitter Widget - displays Latest Tweets','quantumtheme'));
/*		$control_ops = array( 'twitter name' => 'pulsar', 'count' => 3, 'avatar_size' => '32' );
*/		
		parent::__construct('latest-tweets',esc_attr__('[Micro Themes] - Twitter','quantumtheme'),$widget_ops);
	...
	function widget( $args, $instance ) {
		...
		$fa_icon = '<i class="'. (empty( $instance['fa_icon'] ) ? 'fa fa-twitter' : $instance['fa_icon']) .' pm-sidebar-icon"></i> ';
...
function form( $instance ) {
		...
		$defaults = array( 
			'title' => esc_attr__('Twitter','quantumtheme'), 
    	...
    	<p>
		<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_attr_e('Title:', 'quantumtheme') ?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id( 'twitterWidgetID' ); ?>"><?php esc_attr_e('Twitter Widget ID:', 'quantumtheme'); ?> <a href="https://www.pulsarmedia.ca/generating-a-twitter-widget-id/" target="_blank"><?php esc_attr_e('More info', 'quantumtheme'); ?></a></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id( 'count' ); ?>"><?php esc_attr_e('Number of tweets to display:', 'quantumtheme') ?></label>
        ...
        <p>  
            ...
            <label for="<?php echo $this->get_field_id( 'enableLinks' ); ?>"><?php esc_attr_e('Activate Links?', 'quantumtheme'); ?></label>  
        </p>
        ...
        <p>  
            ...
            <label for="<?php echo $this->get_field_id( 'showUser' ); ?>"><?php esc_attr_e('Display User Thumbnail?', 'quantumtheme'); ?></label>  
        </p>
        ...
        <p>  
            ...
            <label for="<?php echo $this->get_field_id( 'showTime' ); ?>"><?php esc_attr_e('Display time of tweet?', 'quantumtheme'); ?></label>  
        </p>
        ...
        <p>  
            ...
            <label for="<?php echo $this->get_field_id( 'showInteraction' ); ?>"><?php esc_attr_e('Display Interaction Links?', 'quantumtheme'); ?></label>  
        </p>
