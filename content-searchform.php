<?php 
	$searchText = get_theme_mod('searchText', esc_attr__( 'Search News Posts', 'quantumtheme' )); 
	$searchFieldText = get_theme_mod('searchFieldText', esc_attr__( 'Type Keywords...', 'quantumtheme' )); 
?>
